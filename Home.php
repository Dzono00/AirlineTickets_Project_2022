...
<head>
  ...
  <link rel="stylesheet" href="./stil/stilTabHome.css">
            ...
            <div class="col-md-3">
                ...
                <div class="nav flex-column nav-pills nav-pills-custom" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <a class="nav-link mb-3 p-3 shadow active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">
                        ...
                        <span class="font-weight-bold small text-uppercase">Pocetna</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">
                        <i class="fa fa-calendar-minus-o mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">PROMO DESTINACIJE</span></a>

                    <a class="nav-link mb-3 p-3 shadow" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">
                        <i class="fa fa-star mr-2"></i>
                        <span class="font-weight-bold small text-uppercase">OTKAZI</span></a>
            ...
            <div class="col-md-9">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <h4 class="font-italic mb-4"><?php
echo "Dobrodosao " . $_SESSION['Username'];
?></h4>
<p>
    Dobrodosao na svoj dashboard! Ovde mozes naci letove za razlicite destinacije. Mi prikazujemo trenutnu ponudu destinacija za <b>promo period od 6 juna do 25 juna!</b>
</p>
                        
                    </div>
                    
                    <div class="tab-pane fade shadow rounded bg-white p-5" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        <h4 class="font-italic mb-4">PROMO DESTINACIJE</h4>
                       <table>
                           <thead>Let 1</thead>
                           <tr>
                               <th scope="col">Avio prevoznik</th>
    ...
    if($rezultat->num_rows>0){
      while($row=$rezultat->fetch_assoc()){
        echo "<tr><td>" . $row['idAvioPrevoznika'] . "</td><td>". $row['aerodrom1_id'] . "</td><td>" .  $row['aerodrom2_id'] . "</td><td>" .  $row['pocetnoVreme'] . "</td><td>" .  $row['VremeSletanja']  . "</td><td>" . $row['sedista'] . "</td><td>" .  $row['cena'] . "</td><td><a href='Bookiraj.php' class='btn btn-success' >Bukiraj</a></tr>";
      }
      echo "</table>";
    }
    else{
